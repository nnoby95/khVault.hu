...
function makeVaultSupportInfoTab() {
    return {
        ...
        getContent: `
            ...
            <p>
                The Vault is in its maintenance phase - no new features are planned, and bugfixes may
                be delayed or ignored entirely. This project is no longer actively maintained, but will
                continue to be hosted. Feel free to report any bugs on the forum thread mentioned above.
            </p>
            <hr>
